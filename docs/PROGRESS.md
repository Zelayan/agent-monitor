...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :--- |
| **WP-14** | **可靠 SSE v2 协议**<br>(单调递增事件ID/环形缓冲/Last-Event-ID/resync_required) | `internal/domain`<br>`transport/http` | PR-Subagent-14<br>`feat/reliable-sse-v2` | `../agent-monitor-worktrees/wt-wp14` | `Pending` | - | 待启动 |
