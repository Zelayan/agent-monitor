...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :--- |
| **WP-14** | **Reliable SSE v2 Protocol**<br>(Monotonic Event IDs / Ring Buffer / Last-Event-ID / resync_required) | `internal/domain`<br>`transport/http` | PR-Subagent-14<br>`feat/reliable-sse-v2` | `../agent-monitor-worktrees/wt-wp14` | `PR Created` | [#36](https://github.com/Zelayan/agent-monitor/pull/36) | 100% Passed & Race-Free (go test -race) |
...
| **WP-16** | **Accessibility, Focus & Motion**<br>(Standard Dialog / Focus Trap / Arrow Nav / Reduced Motion) | `static/index.html` | PR-Subagent-16<br>`feat/a11y-focus-nav` | `../agent-monitor-worktrees/wt-wp16` | `Self-Healed` | Ready for PR | [PASS] 0 BLOCK, 100% tests green |
